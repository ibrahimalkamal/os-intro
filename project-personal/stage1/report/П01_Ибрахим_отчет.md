...
![Сайт на локальном сервере](image/9.png){#fig:010 width=70%}
...
![Отправка изменений на глобальный репозиторий](image/16.png){#fig:018 width=70%}
